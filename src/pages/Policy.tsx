      ...
      >
        <div className="pb-10 mb-8 border-b ">
          ...
          <p>
            ...
            connect to third-party services, which have their own privacy rules
            that Coinly does not control. Coinly takes steps to protect your
            data, but no digital system is completely secure. The service is not
            intended for users under 13 years old. If the Privacy Policy
            changes, continuing to use Coinly means you accept the updated
            terms.
          </p>
        </div>
